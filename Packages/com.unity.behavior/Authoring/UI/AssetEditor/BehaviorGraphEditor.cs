...
#else
            BehaviourAgentBase[] agents = UnityEngine.Object.FindObjectsOfType<BehaviourAgentBase>(true);
#endif
            if (agents == null)
                return;
...
#else
            var agents = UnityEngine.Object.FindObjectsOfType<BehaviourAgentBase>(true);
#endif
