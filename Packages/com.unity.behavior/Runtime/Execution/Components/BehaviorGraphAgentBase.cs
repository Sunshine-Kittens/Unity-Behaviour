...
namespace Unity.Behavior
{
    ...
    /// <para>The BehaviorGraphAgentBase maintains the following lifecycle states:</para>
...
#if NETCODE_FOR_GAMEOBJECTS
    public abstract class BehaviorGraphAgentBase : NetworkBehaviour, ISerializationCallbackReceiver
#else
...
#endif
    {
        ...
        public bool IsStarted => m_IsInitialised;
